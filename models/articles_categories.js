...
module.exports.addArticleCategory = (newArticleCategory, callback) => {
    let req = 'INSERT INTO tcselles.articles_categories SET ?';
...
module.exports.getAllArticlesCategories = (callback) => {
    let req = 'SELECT id, label FROM tcselles.articles_categories';
...
module.exports.getArticleCategory = (id, callback) => {
    let req = 'SELECT id, label FROM tcselles.articles_categories WHERE id=?';
...
module.exports.updateArticleCategory = (updatedArticleCategory, callback) => {
    let req = "UPDATE tcselles.articles_categories SET label=? WHERE id=?";
...
module.exports.deleteArticleCategory = (id, callback) => {
    let req = "DELETE FROM tcselles.articles_categories WHERE id=?";
