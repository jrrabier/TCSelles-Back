...
/* harmony import */ var _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @auth0/angular-jwt */ "./node_modules/@auth0/angular-jwt/fesm2015/auth0-angular-jwt.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [
            ...
            angular2_flash_messages__WEBPACK_IMPORTED_MODULE_12__["FlashMessagesService"],
...
let LoginComponent = class LoginComponent {
    constructor(authService, router, flashMessages) {
...
let AuthService = class AuthService {
    ...
    getProfile() {
        this.loadToken();
        this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Authorization': this.authToken });
        this.headers = this.headers.append('Content-Type', 'application/json');
        return this.http.get('http://localhost:3000/users/profile', { headers: this.headers });
    }
...
module.exports = __webpack_require__(/*! /home/jeromerabier/Documents/Jerome/Projets/TCSelles/angular-src/src/main.ts */"./src/main.ts");
